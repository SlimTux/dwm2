...
static const Key keys[] = {
    ...
    {MODKEY,  XK_e, spawn, {.v = (const char *[]){"rofi", "-show", "emoji", NULL}}},
     ...
     * },
     */
    {MODKEY | ShiftMask, XK_a, spawn, {.v = (const char *[]){"rofi", "-show", "drun", NULL}}},
    ...
    {MODKEY | ShiftMask, XK_F8, spawn, {.v = (const char *[]){"/usr/bin/screenlight.sh", "down",  NULL}}},
    {MODKEY | ShiftMask, XK_F9, spawn, {.v = (const char *[]){"/usr/bin/screenlight.sh", "up", NULL}}},
    {MODKEY, XK_F9, spawn, {.v = (const char *[]){"mounter", NULL}}},
    {MODKEY, XK_F10, spawn, {.v = (const char *[]){"unmounter", NULL}}},
    {MODKEY, XK_F11, spawn, SHCMD("mpv --untimed --no-cache --no-osc --no-input-default-bindings "
    ...
    {0, XK_Print, spawn, SHCMD("maim ~/Pictures/screenshots/$(date '+%d-%m-%Y_%H:%M:%S').png")},
    ...
    {0, XF86XK_MonBrightnessUp, spawn, {.v = (const char *[]){"brillo", "-q", "-A", "10", NULL}}},
    {0, XF86XK_MonBrightnessDown, spawn, {.v = (const char *[]){"brillo", "-q", "-U", "10", NULL}}},
